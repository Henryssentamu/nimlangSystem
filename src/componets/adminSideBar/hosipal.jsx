...
//     { name: "City Hospital", location: "New York", email: "cityhospital@gmail.com" },
//     { name: "Green Valley Medical", location: "Los Angeles", email: "gvmedical@gmail.com" },
//     { name: "Sunrise Clinic", location: "Chicago", email: "sunriseclinic@gmail.com" },
//   ]);

//   const filteredHospitals = hospitals.filter((hospital) => hospital.name.toLowerCase().includes(search.toLowerCase()));

//   const handleAddHospital = () => {
//     const newHospital = { name: "New Hospital", location: "Unknown", email: "newhospital@gmail.com" };
...
//       {/* Add Hospital Button */}
//       <button className="btn btn-primary w-100" onClick={handleAddHospital}>
//         Add Hospital
//       </button>
//     </div>
//   );
